...
interface ProgressiveDualStepProps {
    questions: Question[];
    answers: SurveyAnswers;
    onChangeAnswer: (questionId: string, value: AnswerValue) => void;
}

function ProgressiveDualStep({
    questions,
    answers,
    onChangeAnswer,
}: ProgressiveDualStepProps) {
    ...
    const handleSelectSecond = (value: string) => {
        const nextValue = secondValue === value ? "" : value;

        onChangeAnswer(secondQuestion.id, nextValue);
    };
                ...
                {hasFirstSelection && !showFirstQuestionExpanded ? (
                    ...
                    >
                        <QuestionField
                            ...
                            value={secondValue}
                            answers={answers}
                            onChangeAnswer={(_, value) => {
                                if (typeof value === "string") {
                                    handleSelectSecond(value);
                                }
                            }}
                        />
                    </motion.div>
...
export default ProgressiveDualStep;
